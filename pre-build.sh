...
sed -i 's/padding-left: 5px/padding-left: 30px/' padavan-ng/trunk/user/www/n56u_ribbon_fixed/Advanced_System_Info.asp
sed -i 's/padding-left: 5px/padding-left: 30px/' padavan-ng/trunk/user/www/n56u_ribbon_fixed/Main_TrafficMonitor_realtime.asp
...
cp -vp router_r3.png padavan-ng/trunk/user/www/n56u_ribbon_fixed/bootstrap/img/wl_device/
...
sed -i 's/time.in.ua/ntp.ix.ru/' padavan-ng/trunk/user/shared/defaults.h
sed -i 's/time.in.ua/ntp.ix.ru/' padavan-ng/trunk/user/scripts/mtd_storage.sh
grep '^server=' padavan-ng/trunk/user/scripts/mtd_storage.sh
